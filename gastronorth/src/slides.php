<div class="demo-2 hidden-sm hidden-xs">
  <div id="slider" class="sl-slider-wrapper">
    <div class="sl-slider">
      <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
        <div class="sl-slide-inner">
          <a href="<?php echo ROOT;?>/clinico" title="imagem médicos gastronorte"><div class="bg-img bg-img-1" ></div></a>
      ...
      <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
        <div class="sl-slide-inner">
          <a href="<?php echo ROOT;?>/exames" title="exames Gastronorte"><div class="bg-img bg-img-3"></div></a>
          ...
          living and who endured the awful suffering and the terror of the abattoirs.</p><cite>Dame Jane Morris Goodall</cite></blockquote>-->
        </div>
      </div>
      ...
      <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
        <div class="sl-slide-inner">
          ...
          <h2>Orientações Pré-exames</h2>
          <blockquote>
            <p>Siga aqui todas nossas orientações, para os principais exames tranquilos
              e responsável a Gastronorte oferece todo suporte Pré exame</p>
            <a href="<?php echo ROOT;?>/orientacoes" title="orientações gastronorte">
